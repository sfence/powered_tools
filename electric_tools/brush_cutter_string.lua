...
powered_tools.brush_cutter_string_electric = appliances.tool:new(
    {
      tool_name = "powered_tools:brush_cutter_string_electric",
      
      tool_description = S("Electric Brush Cutter with String"),
...
local brush_cutter = powered_tools.brush_cutter_string_electric;
...
brush_cutter:register_tool({
    inventory_image = "powered_tools_brush_cutter_string.png^powered_tools_brush_cutter_electric_body.png",
  })
